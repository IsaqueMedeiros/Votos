import Carousel from '../../components/Carousel/CarouselCasamentos/Carousel'

const CasamentosTemplate2 = () => {
    return (
        <main id='casamentos' className='min-h-screen bg-votosRed grid grid-cols-1 lg:grid-cols-2 content-evenly gap-16 lg:gap-0 overflow-hidden py-12' >
