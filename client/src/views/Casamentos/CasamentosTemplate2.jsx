...
const CasamentosTemplate2 = () => {
    return (
        <main className='min-h-screen bg-votosRed grid grid-cols-1 lg:grid-cols-2 content-evenly gap-8 overflow-hidden py-12' >
            <div id='casamentos' className='w-min h-min flex flex-col items-start justify-center ml-14 lg:ml-20 overflow-hidden' >
